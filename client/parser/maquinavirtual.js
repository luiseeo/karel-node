...
,initialize: function (cuadruplos,commands,mundo){
		...
		this.error = "No hay un programa compilado para ejecutar";
		return 1;
	}
...
,execute: function (){
		...
		cuadruplo = this.cuadruplos[this.PC];
				...
				case this.commands.AVANZA:
					...
					this.error = "Karel quiso pasar sobre una pared!";
					this.freeMemory();
					return 1;
				    } else {
					switch( this.karelo){
				...
				case this.commands.DEJA_ZUM:
					...
					this.mundo.zumbadores.poner(this.karelx,this.karely,zumbadores);
				    	...
				    	this.error = "Karel quiso dejar un zumbador y tenia la mochila vacia!";
					this.freeMemory();
					return 1;
				    }
				    this.PC++;
				...
				case this.commands.COGE_ZUM:
					...
					this.mundo.zumbadores.poner(this.karelx,this.karely,zumbadores);
				    	...
				    	this.error = "Karel quiso coger un zumbador donde no habia!";
					this.freeMemory();
					return 1;
				    }
				    this.PC++;
